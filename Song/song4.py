class Song:
    ...
    def __init__(self, title, artist, duration=0):
        ...
        """
        """ https://www.python.org/dev/peps/pep-0257        # PEP about docstrings"""
...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        This method will add the song ro an album in the colection.
        Anew album will lbe created in th collection if it doesn't already exist.
